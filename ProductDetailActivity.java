...
public class ProductDetailActivity extends AppCompatActivity implements View.OnClickListener  {
    ...
    private void loadItemDeatils() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://"+ip+"/Aumento/Shopping/itemDetails.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    String item_price = data.getString("rate");
                    String item_offer = data.getString("offer");
...
//                    priceTV.setText("₹ "+item_price);
    ...
    private void LoadImage() {
        ...
        viewPager.setAdapter(new SlidingImage_Adapter(ProductDetailActivity.this,ImagesArray));
